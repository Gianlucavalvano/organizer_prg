...
def crea_vista_archivio(page: ft.Page):
    ...
    # Carica mappa stati (per visualizzare descrizione stato)
    ...
    def ricarica_archivio():
        ...
        for p in dati:
            ...
            def click_ripristina(e, id_progetto=p_id):
                if db.ripristina_progetto_db(id_progetto):
                    page.snack_bar = ft.SnackBar(
                        ft.Text("Progetto ripristinato in Gestione!"), bgcolor="green"
                    )
            ...
            # Card contenitore
            card = ft.Card(content=ft.Container(content=tile, padding=10), margin=5)
            ...
            for t in tasks:
                ...
                riga = ft.Row(
                    controls=[
                        ...
                        ft.ProgressBar(
                            value=(t_perc or 0) / 100,
                            width=50,
                            color="blue",
                            bgcolor="white",
                        )
                        if t_tipo != 3
                        else ft.Container(width=50),
                    ],
